...
import manifest from '@museumwnf/the-table-is-set-data'
import partnerNamesEn from '@museumwnf/the-table-is-set-data/translations/partners.en.json'
import dynastyNamesEn from '@museumwnf/the-table-is-set-data/translations/dynasties.en.json'
...
describe('website smoke test', () => {
  ...
  it('renders the shared texts and its own over them', async () => {
    ...
    expect(checkTextsRendered(host, {
      namespaces: ['theTableIsSet', 'core', 'layout', 'catalogue', 'record', 'sheet', 'timeline', 'partner', 'exhibition'],
    })).toEqual([])
