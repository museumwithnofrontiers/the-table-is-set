...
export default {
  ...
  home: {
    title: 'theTableIsSet.identity.title',
    intro: 'theTableIsSet.home.intro',
    cards: [
      {
        title: 'theTableIsSet.nav.catalogue',
        description: 'theTableIsSet.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'theTableIsSet.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'theTableIsSet.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'theTableIsSet.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'theTableIsSet.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'theTableIsSet.partnerObjects.emptyPartner',
  //         emptyInstitution: 'theTableIsSet.partnerObjects.emptyInstitution',
  //         institutionSummary: 'theTableIsSet.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'theTableIsSet.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'theTableIsSet.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
