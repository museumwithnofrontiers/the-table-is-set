...
// (`npm pack @museumwnf/the-table-is-set-data`) — never the legacy project
...
export const projectColors = {
  '09bed55d-efe6-50e0-8c24-1647bc9822eb': 'exhibition', // The Table Is Set (this exhibition's own project, or borrowed from another exhibition — shares the 'exhibition' family)
...
export default {
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/the-table-is-set' },
